...
namespace EF6_CodeFirst_DrivingSchool.Controllers
{
    public class Ref_Lesson_StatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LessonStatusCode,LessonStatusDescription")] Ref_Lesson_Status ref_Lesson_Status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LessonStatusCode,LessonStatusDescription")] Ref_Lesson_Status ref_Lesson_Status)
        {
            if (ModelState.IsValid)
            {
