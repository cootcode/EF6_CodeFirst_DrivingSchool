...
namespace EF6_CodeFirst_DrivingSchool.Controllers
{
    public class Ref_Customer_StatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerStatusCode,CustomerStatusDescription")] Ref_Customer_Status ref_Customer_Status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerStatusCode,CustomerStatusDescription")] Ref_Customer_Status ref_Customer_Status)
        {
            if (ModelState.IsValid)
            {
